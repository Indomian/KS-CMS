...
<div class="pages" style="overflow:visible;">
	<div class="pages_nav">
		{#page#}:
		{if $pages.active==1}
		<a><img src="{#images_path#}/icons2/first_disabled.gif" alt="&lt;" height="9" width="8"></a>
		<a><img src="{#images_path#}/icons2/previous_disabled.gif" alt="&lt;" height="9" width="8"></a>
		{else} 
		<a href="{get_url _CLEAR="p[0-9]*" i=$pages.index}&p{$pages.index}=1"><img src="{#images_path#}/icons2/first.gif" alt="&lt;" height="9" width="8"></a>
		<a href="{get_url _CLEAR="p[0-9]*" i=$pages.index}&p{$pages.index}={$pages.active-1}"><img src="{#images_path#}/icons2/previous.gif" alt="&lt;" height="9" width="8"></a>
		{/if}
		...
		<label>
			...
			<div class="pseudo_select">
				<div class="pseudo_select_in">
					<div class="pseudo_select_in_in" onclick="this.nextSibling.style.display=(this.nextSibling.style.display=='none'?'':'none');">{$pages.visible}</div>
