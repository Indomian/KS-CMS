...
$sResult.='<a id="del'.$rand.'" href="#" style="margin-left:6px;"><img style="vertical-align: middle;" src="/uploads/templates/admin/images/icons2/delete.gif"/></a>';
$sResult.='<script type="text/javascript">' ."\n".
		...
		'$("input#select'.$rand.'").click(function(event){'."\n";
			if($params['field']['option_1']=="blog")
				$sResult.='kstb_show("Выбрать раздел","/admin.php?module='.$params['field']['option_1'].'&page=sections&mode=small&width=800&height=480",null,showForm'.$rand.');';
			else
