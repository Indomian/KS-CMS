<?php
/**
 * Файл описания меню главного модуля
 *
 * @filesource main/admin.menu.inc.php
...
if($this->obUser->IsLogin())
{
	...
	if ($access<=10)
	{
		...
		if ($access <= 7) $this->AddMenuItem(MenuItem("TEMPLATES","MAIN","module=main&modpage=templates",$this->GetText('menu_templates'),'template.gif '),"GLOBAL");
		...
		if ($access == 0) $this->AddMenuItem(MenuItem("UPDATE","MAIN","module=main&modpage=geography",$this->GetText('menu_geography'),'globe_model.png '),"GLOBAL");
	}
}
